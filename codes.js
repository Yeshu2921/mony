...
const countryList = {
    ...
    BAM: "BA", // Bosnian and Herzegovina Convertible Mark
    ...
    EUR: "FR", // Euro (Using France flag as a representative)
    ...
    MRO: "MR", // Mauritanian Ouguiya (old)
    ...
    STN: "ST", // São Tomé and Príncipe Dobra (new)
    ...
    VEF: "VE", // Venezuelan Bolívar Fuerte (old)
    VES: "VE", // Venezuelan Bolívar Soberano (new)
    VND: "VN", // Vietnamese Đồng
    VUV: "VU", // Vanuatu Vatu
    WST: "WS", // Samoan Tala
    XAF: "CF", // CFA Franc BEAC (Using Central African Republic flag)
    XCD: "VC", // East Caribbean Dollar (Using St. Vincent flag)
    XOF: "SN", // CFA Franc BCEAO (Using Senegal flag)
    XPF: "PF", // CFP Franc (Using French Polynesia flag)
    YER: "YE", // Yemeni Rial
